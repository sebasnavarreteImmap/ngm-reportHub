				...
				$scope.model = {
					...
					header: {
						...
						title: {
							...
							title: $filter('translate')('nutrition') + ' Afghanistan | ' + $filter('translate')('assessment')+' | '+$filter('translate')('form') + ' | ' + ($route.current.params.mode==='i'||$route.current.params.mode==='x'?$filter('translate')('new'):$filer('translate')('edit'))
						},
						subtitle: {
