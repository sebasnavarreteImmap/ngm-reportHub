...
angular
	...
	.config([ '$routeProvider', '$locationProvider', '$compileProvider','$translateProvider', function ( $routeProvider, $locationProvider, $compileProvider,$translateProvider ) {
     ...
     $translateProvider.translations('en',{
       ...
       "email_account_to_reset_your_password":"email account to reset your password",
       "the_email_will_contain_a_secure_link_to_reset_your_password, so you can close this window.":"The email will contain a secure link to reset your password, so you can close this window.",
  ...
  $translateProvider.translations('es',{
    ...
    "please_check_your":"Por favor revise su",
    "email_account_to_reset_your_password":"cuenta de email para restablecer su password",
    "the_email_will_contain_a_secure_link_to_reset_your_password, so you can close this window.":"El email contendrá un enlace seguro para restablecer su contraseña, puede cerrar esta ventana.",
